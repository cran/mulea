...
author: >
  <div class="author-row">
    <span class="author">Cezary Turek,</span>
    <span class="author">Márton Ölbei,</span>
    <span class="author">Tamás Stirling (stirling.tamas@gmail.com),</span>
    <span class="author">Gergely Fekete,</span>
    <span class="author">Ervin Tasnádi,</span>
    <span class="author">Leila Gul,</span>
    <span class="author">Balázs Bohár,</span>
    <span class="author">Balázs Papp,</span>
    <span class="author">Wiktor Jurkowski &</span>
    <span class="author">Eszter Ari</span>
  </div>
date: "`r Sys.Date()`"
output:
...
`mulea` is compatible with the MsigDB (Subramanian et al. 2005) [GMT files](https://www.gsea-msigdb.org/gsea/msigdb/). Download and read such a GMT file (*e. g.* [c3.tft.v2023.2.Hs.symbols.gmt]{.underline}) locally. *Note that this ontology is not suitable for analyzing the Escherichia coli differential expression data described in the section [The Differential Expression Dataset to Analyse].*
